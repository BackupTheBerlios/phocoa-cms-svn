<?php /* Smarty version 2.6.12, created on 2006-02-26 17:44:34
         compiled from C:/web/helloworld/helloworld/modules/examples/concepts/bindings/example.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'WFURL', 'C:/web/helloworld/helloworld/modules/examples/concepts/bindings/example.tpl', 35, false),array('function', 'WFLabel', 'C:/web/helloworld/helloworld/modules/examples/concepts/bindings/example.tpl', 60, false),array('function', 'WFTextField', 'C:/web/helloworld/helloworld/modules/examples/concepts/bindings/example.tpl', 188, false),)), $this); ?>
...
<div class="exampleBox">
    ...
    <h3>Output</h3>
    <?php echo smarty_function_WFLabel(array('id' => 'simpleBinding'), $this);?>
...
<div class="exampleBox">
    ...
    <h3>Output</h3>
    <?php echo smarty_function_WFLabel(array('id' => 'multOneOn'), $this);?>
<br />
    <?php echo smarty_function_WFLabel(array('id' => 'multOneOff'), $this);?>
(hidden WFLabel exists, but is hidden)<br />
    <?php echo '
    <h3>Template</h3>
    <pre>
...
<div class="exampleBox">
    ...
    <h3>Output</h3>
    <?php echo smarty_function_WFLabel(array('id' => 'multMultHiddenOn'), $this);?>
<br />
    <?php echo smarty_function_WFLabel(array('id' => 'multMultHiddenOff'), $this);?>
(hidden WFLabel exists, but is hidden)<br />
    <?php echo '
    <h3>Template</h3>
    <pre>
...
<div class="exampleBox">
    ...
    <h3>Output</h3>
    <?php echo smarty_function_WFTextField(array('id' => 'multMultEnabledOn'), $this);?>
<br />
    <?php echo smarty_function_WFTextField(array('id' => 'multMultEnabledOff'), $this);?>
<br />
    <?php echo '
    <h3>Template</h3>
    <pre>
...
<div class="exampleBox">
    ...
    <h3>Output</h3>
    <?php echo smarty_function_WFLabel(array('id' => 'valuePattern'), $this);?>
<br />
    <?php echo '
    <h3>Template</h3>
    <pre>
...
<div class="exampleBox">
    ...
    <h3>Output</h3>
    <?php echo smarty_function_WFLabel(array('id' => 'hideIfEmpty'), $this);?>
<br />
    <?php echo smarty_function_WFLabel(array('id' => 'hideIfNotEmpty'), $this);?>
<br />
    <?php echo '
    <h3>Template</h3>
    <pre>
